...
import 'adminchatscreendietition.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collectionGroup('messaging').snapshots(),
              ...
              return ListTile(
                ...
                onTap: () async {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => adminschatscreentodiet(userId: userId),
                    ),
                  );
                },
              );

...
class losstable extends StatefulWidget {
  @override
  _LossTableState createState() => _LossTableState();
}

class _LossTableState extends State<losstable> {
  ...
  Future<void> fetchData() async {
    try {
      QuerySnapshot querySnapshot = await _firestore.collection('weight_loss_users').get();
      setState(() {

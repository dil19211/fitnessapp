...
class losspreminum extends StatefulWidget {
  const losspreminum({Key? key}) : super(key: key);
  @override
  State<losspreminum> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<losspreminum> {
                          ...
                          children: [
                            ...
                            itemDashboard(
                              ...
                              'assets/images/walk.jpg',
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (BuildContext context) => lossstep(),
